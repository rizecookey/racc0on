...
public sealed abstract class AbstractBinaryOperationNode extends AbstractNode implements BinaryOperationNode permits AbstractCommutativeBinaryOperationNode, DivNode, GreaterNode, GreaterOrEqNode, LessNode, LessOrEqNode, ModNode, ShiftLeftNode, ShiftRightNode, SubNode {
    protected AbstractBinaryOperationNode(Block block, Node left, Node right) {
        super(block, left, right);
    }

    protected AbstractBinaryOperationNode(Block block, Node left, Node right, Node sideEffect) {
