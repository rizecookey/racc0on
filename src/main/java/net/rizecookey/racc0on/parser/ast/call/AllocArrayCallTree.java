...
public record AllocArrayCallTree(TypeTree type, ExpressionTree elementCount, Span span) implements CallTree {
    @Override
    ...
    public Name functionName() {
        return Name.forKeyword(AllocKeywordType.ALLOC_ARRAY);
    }

    @Override
    public List<ExpressionTree> arguments() {
        return List.of(elementCount());
    }
}
